    ...
    return (
        ...
        <div className="p-4">
            <div className="card shadow-xl relative overflow-hidden h-96 w-full transform transition-all duration-300 hover:scale-105 hover:brightness-125">
                ...
                <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-end p-4 bg-opacity-50 bg-black">
                    <h2 className="card-title text-white text-center">{brandName}</h2>
                </div>
            </div>
        </div>
        </Link>
